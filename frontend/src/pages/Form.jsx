 ...
 * Includes all required backend fields: title, description, regulatoryBody, category, status, priority, effectiveDate
 * Security: Only required fields are sent. No unknown fields.
 * Accessibility: All fields have labels and required indicators.
 */
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input className="w-full px-3 py-2 border rounded" placeholder="Category" value={form.category} onChange={e => setForm({ ...form, category: e.target.value })} required />
                    </div>
                </div>
